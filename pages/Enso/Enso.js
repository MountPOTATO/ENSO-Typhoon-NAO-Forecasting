...
Component({
  ...
  methods:{
    ...
    getData_btn()
    {
      ...
      console.log(month)
      wx.request({
        url: 'http://1.117.40.47:8080/queryEnsoData1?year='+this.data.date.slice(0,4),
        method:'GET',
  ...
  pageLifetimes: {
    show() {
      var that = this;
      wx.request({
        url: 'http://1.117.40.47:8080/queryEnsoYear',
        headers: {
        ...
        success: function (res) {
          ...
          wx.request({
            url: 'http://1.117.40.47:8080/queryEnsoData1?year='+str1.slice(0,4),
            method:'GET',
            success:function(res){
              console.log(res)
              var list=res.data;
